...
public class TomorrowLandFragment extends Fragment {
    HuntItemViewModel viewModel;

    public TomorrowLandFragment() {
        super(R.layout.fragment_tomorrow_land);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ScavengerHuntAdapter adapter = new ScavengerHuntAdapter(
                getActivity(),
                viewModel.getLandHuntItems("Tomorrowland"),
                (huntItem) -> {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.tomorrow_hunt_items);

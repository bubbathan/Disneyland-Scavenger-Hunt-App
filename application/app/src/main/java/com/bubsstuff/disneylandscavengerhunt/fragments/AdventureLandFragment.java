...
public class AdventureLandFragment extends Fragment {
    HuntItemViewModel viewModel;

    public AdventureLandFragment() {
        super(R.layout.fragment_adventure_land);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ScavengerHuntAdapter adapter = new ScavengerHuntAdapter(
                getActivity(),
                viewModel.getLandHuntItems("Adventureland"),
                (huntItem) -> {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.adventure_hunt_items);

...
public class CaAdventureFragment extends Fragment {
    HuntItemViewModel viewModel;

    public CaAdventureFragment() {
        super(R.layout.fragment_ca_adventure);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ScavengerHuntAdapter adapter = new ScavengerHuntAdapter(
                getActivity(),
                viewModel.getLandHuntItems("CA Adventure"),
                (huntItem) -> {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.ca_adventure_hunt_items);

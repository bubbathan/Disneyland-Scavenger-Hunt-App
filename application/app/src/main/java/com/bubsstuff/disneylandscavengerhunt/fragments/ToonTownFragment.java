...
public class ToonTownFragment extends Fragment {
    HuntItemViewModel viewModel;

    public ToonTownFragment() {
        super(R.layout.fragment_toon_town);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ScavengerHuntAdapter adapter = new ScavengerHuntAdapter(
                getActivity(),
                viewModel.getLandHuntItems("Toontown"),
                (huntItem) -> {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.toontown_hunt_items);

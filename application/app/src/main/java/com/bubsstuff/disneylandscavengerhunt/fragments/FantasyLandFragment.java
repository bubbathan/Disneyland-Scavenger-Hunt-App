...
public class FantasyLandFragment extends Fragment {
    HuntItemViewModel viewModel;

    public FantasyLandFragment() {
        super(R.layout.fragment_fantasy_land);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ScavengerHuntAdapter adapter = new ScavengerHuntAdapter(
                getActivity(),
                viewModel.getLandHuntItems("Fantasyland"),
                (huntItem) -> {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.fantasy_hunt_items);
